...
CartProductsController.findByIdAndUpdate = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const product = yield cart_products_service_1.CartProductsService.findByIdAndUpdate(new mongoose_1.Types.ObjectId(id), {
            quantity,
        });
...
CartProductsController.findByIdAndDelete = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        yield cart_products_service_1.CartProductsService.findByIdAndDelete(new mongoose_1.Types.ObjectId(id));
